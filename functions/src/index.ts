  ...
  .onCreate(async (snap, context) => {
    ...
    try {
      ...
      const notification = {
        ...
        body: `${userName} ordered ${itemCount} items - $${total.toFixed(2)}`
      };
...
export const updateAdminToken = functions.firestore
...
export const cleanupOldNotifications = functions.firestore
