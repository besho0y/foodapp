...
// Simple helper function to group cart items by restaurant
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                                height: 8.h),
                                                            // Calculate delivery fees with area-based logic
                                                            Builder(
                                                              builder:
                                                                  (context) {
                                                                // Use the new area-based calculation method
                                                                Map<String,
                                                                        double>
                                                                    feeBreakdown =
                                                                    cubit.calculateDeliveryFeesWithAreaLogic(
                                                                        context);
